...
public class StatementSteps {
	...
	public void no_statements_should_be_displayed() throws InterruptedException {
		Thread.sleep(5000);
		Boolean element = driver.findElements(By.xpath("//*[@id=\"statement_row_0\"]")).size() == 0;
		Assert.assertTrue("test message", element==true);
	...
	public void statement_for_other_dates$_should_not_be_displayed(DataTable testdata) throws InterruptedException {
		Thread.sleep(5000);
	...
	public void before_balance_should_be(String before_balance) {
		Assert.assertTrue("Incorrect balance before is displayed",driver.getPageSource().contains("Balance before:" + " " + before_balance + " " + "EUR"));
	}
	...
	public void balance_after_should_be(String after_balance) {
		Assert.assertTrue("Incorrect balance after is displayed",driver.getPageSource().contains("Balance after" + " " + after_balance + " " + "EUR"));
	}
